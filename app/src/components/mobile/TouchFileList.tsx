    ...
    <>
      {isLoading && (
        <div className="flex flex-col items-center justify-center py-16 space-y-3 text-center">
          ...
          <p className="text-xs text-telegram-subtext font-semibold">正在获取你的文件...</p>
        </div>
      )}
      ...
      {!isLoading && files.length === 0 && (
        <div className="flex flex-col items-center justify-center py-16 space-y-3 text-center px-4">
          ...
          <h4 className="text-sm font-bold text-telegram-text">此文件夹为空</h4>
        ...
        <>
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            >
              ...
              {isSelectionActive ? `已选择 ${selectedIds.length} 项` : '选择'}
            </button>
            {isSelectionActive && (
              <>
                <button
            ...
            >
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-sm font-bold text-white">移动 {selectedIds.length} 个文件到...</h3>
                  <button
                    onClick={() => setShowMovePicker(false)}
                ...
                <div className="flex-1 overflow-y-auto space-y-1 min-h-0">
                  ...
                  {folders.filter(f => f.id !== activeFolderId).length === 0 && (
                    <p className="text-xs text-telegram-subtext/60 text-center py-4">没有其他可用文件夹</p>
                  )}
                </div>
              </div>
            </div>
                  ...
                  <div className="flex items-center gap-3.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="text-[10px] text-telegram-subtext/80 font-medium">{file.created_at || '同步'}</span>
                      </div>
                    </div>
                  </div>
